...
urlpatterns = [
    ...
    path('home/', views.BrassinsList, name="brassin_list"),
    ...
    path('nouvelle-note/', views.NoteCreate.as_view(), name='note_create'),
    path('edit-note-<int:pk>/', views.NoteUpdate.as_view(), name='note_update'),
    path('supprimer-note-<int:pk>/', views.NoteDelete.as_view(), name='note_delete'),
