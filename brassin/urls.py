...
urlpatterns = [
    ...
    path('recettes/<int:pk>/supprimer-ingredient/', views.RecetteIngredientDelete.as_view(), name='recette_ingredient_delete'),
    ...
    path('achats/ajouter/', views.AchatCreate.as_view(), name='achat_create'),
